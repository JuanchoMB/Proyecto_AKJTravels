...
public record CreateAccommodationDTO(
        ...
        @Length(min = 5, max = 25, message = "El título debe tener entre 5 y 25 caracteres") String title,
        @NotBlank(message = "La descripción no puede estar vacía")
        @Size(min = 20, max = 500, message = "La descripción debe tener entre 20 y 500 caracteres") String description,
        ...
        @NotBlank @Pattern(regexp = "^[0-9A-Za-z]{4,10}$", message = "El código postal no es válido") String postalCode,
